...
//     const endpoint = type === "signup" ? "/api/register/" : "/api/login/";
//     const body = type === "signup" ? formData : { username: formData.username, password: formData.password };
...
//   return (
//     <div className="w-full max-w-md rounded-3xl border border-gray-700 bg-gray-800/90 backdrop-blur-sm p-10 shadow-xl animate-fade-in">
      
//       {/* Brand */}
//       <div className="mb-8 text-center">
//         <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-gray-700 to-gray-900 text-white font-bold shadow-lg">
//           S
//         </div>
...
//           placeholder="Username"
//           required
//           className="w-full rounded-xl border border-gray-600 bg-gray-900/80 px-5 py-3 text-gray-100 placeholder-gray-400 focus:border-emerald-500 focus:outline-none focus:ring-4 focus:ring-emerald-500/30 transition"
//         />
...
//         {error && (
//           <div className="rounded-lg border border-red-600 bg-red-700/20 px-4 py-2 text-sm text-red-300">
//             {error}
//           </div>
//         )}
...
//           disabled={loading}
//           className={`mt-2 w-full rounded-xl py-3 font-semibold text-white shadow-lg transition-all
//             ${loading ? "cursor-not-allowed bg-gray-500" : "bg-gradient-to-r from-gray-700 to-gray-900 hover:brightness-110"}`
//           }
//         >
//           {loading ? (
//             <span className="flex items-center justify-center gap-2">
...
//           <p>
//             Already have an account?
//             <a href="/signin" className="ml-2 font-semibold text-emerald-400 hover:underline inline-flex items-center group">
//               Sign In
//               <ArrowForwardIcon className="ml-1 text-sm group-hover:translate-x-1 transition-transform" />
//             </a>
//           </p>
...
//           <p>
//             Don’t have an account?
//             <a href="/signup" className="ml-2 font-semibold text-emerald-400 hover:underline inline-flex items-center group">
//               Sign Up
//               <ArrowForwardIcon className="ml-1 text-sm group-hover:translate-x-1 transition-transform" />
//             </a>
//           </p>
