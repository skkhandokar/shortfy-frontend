...
//   onClick={(e) => {
//     console.log("🟢 Clicked shortUrl link")
...
//   const shortUrl = `https://skkhandokar22.pythonanywhere.com/api/check/${url.short_code}`
...
//             <div className="flex items-center gap-2 mb-3 flex-wrap">
//               <MuiLink
//                 href={shortUrl}      // Direct backend check URL
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="text-indigo-600 hover:text-indigo-800 font-bold text-lg break-all"
//               >
//                 {shortUrl.replace('https://skkhandokar22.pythonanywhere.com/api/check/', 'shortfy.xyz/')}
//               </MuiLink>

//               <Button size="small" variant="outlined" onClick={handleCopy}>Copy</Button>
//               {copied && <span className="text-green-600 text-sm font-medium">Copied!</span>}
//               <Button size="small" variant="outlined" onClick={() => setOpen(true)}>QR</Button>
//               <Button
//                 size="small"
//                 variant="outlined"
//                 color="secondary"
...
//           <p className="text-sm text-gray-500 mt-4 break-all">{shortUrl}</p>
//           <div className="mt-4 flex justify-center gap-4">
//             <Button onClick={handleDownload} variant="outlined" color="primary">Download QR</Button>
